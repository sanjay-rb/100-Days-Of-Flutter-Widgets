          ...
          children: <Widget>[
            Flexible(
               ...
               */
                ...
                child: Container( // ? this is the place where we give the Tip Tool....
                  color: Colors.amber,
                  width: 100,
                  height: 100,
                ),
            ...
            Flexible(
              child: Tooltip(
                waitDuration: Duration(seconds: 1), // ! we can specify the wait time for the hover....
                showDuration: Duration(seconds: 5), // ! and we can also specify the show time for the tooltip....
