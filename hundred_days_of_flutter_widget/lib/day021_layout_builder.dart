...
class Day21LayoutBuilder extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      ...
      builder: (BuildContext context, BoxConstraints constraints) {
         ...
         */
        if (constraints.maxWidth > 600.0) { // ? check for the max width is greater than 600(a normal phone width)....
          return doubleBox(); // ! then change the ui by 2 Container Box....
        } else if (constraints.maxHeight < 350.0) { // ? check for the max with is lesser than 350.0(normal phone half height)....
          return multiBox(); // ! then change the ui to multi Container Box....
        } else { //  ? if it is normal phone in [Portrait] mode....
  ...
  Widget singleBox() {
    return Center(
      child: Container( // ! creating the single container with 300x300....
        height: 300.0,
        width: 300.0,
        color: Colors.red,
      ),
  ...
  Widget doubleBox() { // ! creating the double container with 300x300....
    return Center(
      child: Row(
  ...
  Widget multiBox() { // ! creating the multi container with 90x90....
    double boxsize = 90;
    return Center(
      child: Wrap(
        runSpacing: 10,
