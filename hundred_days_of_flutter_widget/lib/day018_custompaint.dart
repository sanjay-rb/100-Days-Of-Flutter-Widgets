...
class MyPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawLine(Offset(0, 0), Offset(size.width, size.height), p); // ! and we can darw the line [drawLine]....

    p..color = Colors.green; // ! we can give the pick color...
    p..style = PaintingStyle.stroke; // ! we can adjust the style....
    canvas.drawCircle(Offset(size.width / 2, size.height / 2), 100, p); // ! and we can darw the Circle [drawCircle]....

    Path path = Path(); // ! with the help of [path] we can travel arround the canvas....
